...
//////////////////////////////////////////////
const char SSID_ESP[] = "LANtern2";                   //Give EXACT name of your WIFI
const char SSID_KEY[] = "A52E9A7197";                //Add the password of that WIFI connection
const char* host = "ragnarssons.000webhostapp.com";  //Add the host without "www" Example: electronoobs.com
